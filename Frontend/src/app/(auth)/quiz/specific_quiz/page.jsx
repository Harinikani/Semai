...
const QUIZ_CACHE_KEY = "specificQuizState";
...
const Page = () => {
    ...
    const fetchQuizzes = async () => {
      ...
      try {
        const res = await fetch(
          `${API_BASE}/quiz/generate-specific-quiz?token=${authToken}`,
          {
            method: "GET",
            headers: {
  ...
  // --- Enhanced rewards calculation (points + currency) ---
  ...
  // --- Add both points and currency to user ---
  ...
  const renderResults = () => {
    ...
    return (
      <div id="result-card" className="text-center m-0">
        ...
        {/* ADD THIS REWARDS DISPLAY SECTION - SAME AS GENERAL QUIZ */}
        ...
        <div className="max-w-md mx-auto pb-20">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Specific Quiz</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
